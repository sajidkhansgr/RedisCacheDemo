...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=Notebook-Pro;Initial Catalog=AdventureWorks2019;Integrated Security=true;Encrypt=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer1>(entity =>
        {
            ...
            entity.HasOne(d => d.Person).WithMany(p => p.Customer1s).HasForeignKey(d => d.PersonId);

            entity.HasOne(d => d.Store).WithMany(p => p.Customer1s).HasForeignKey(d => d.StoreId);

            entity.HasOne(d => d.Territory).WithMany(p => p.Customer1s).HasForeignKey(d => d.TerritoryId);
        });
        ...
        modelBuilder.Entity<Employee1>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithOne(p => p.Employee1)
        ...
        modelBuilder.Entity<Product1>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductModel).WithMany(p => p.Product1s).HasForeignKey(d => d.ProductModelId);

            entity.HasOne(d => d.ProductSubcategory).WithMany(p => p.Product1s).HasForeignKey(d => d.ProductSubcategoryId);

            entity.HasOne(d => d.SizeUnitMeasureCodeNavigation).WithMany(p => p.Product1SizeUnitMeasureCodeNavigations).HasForeignKey(d => d.SizeUnitMeasureCode);

            entity.HasOne(d => d.WeightUnitMeasureCodeNavigation).WithMany(p => p.Product1WeightUnitMeasureCodeNavigations).HasForeignKey(d => d.WeightUnitMeasureCode);
        });
